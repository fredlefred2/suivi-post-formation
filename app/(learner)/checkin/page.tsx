  ...
  if (!checkinCtx.isOpen) {
    return (
      <div className="space-y-6 pb-4">
        <div className="rounded-2xl p-4 relative overflow-hidden" style={{ background: '#1a1a2e', boxShadow: '0 8px 30px rgba(26, 26, 46, 0.3)' }}><div className="absolute -top-8 -right-8 w-32 h-32 rounded-full bg-white/10" /><div className="absolute -bottom-10 -left-6 w-24 h-24 rounded-full bg-white/5" /><div className="relative"><h1 className="text-xl font-extrabold text-white">Check-in hebdomadaire</h1><p className="text-xs text-white/50 mt-0.5">Fais le point sur ta semaine</p></div></div>
